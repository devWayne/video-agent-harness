...
description: Evaluate a generated video candidate against its ShotIntent, continuity anchors, reference assets, and technical delivery requirements. Use when deciding whether to accept a candidate, retry H3 control, regenerate LibTV refinement, request human review, compare candidates, or create a structured quality report for the Harness.
---
...
2. Confirm the candidate is readable and inspect representative temporal samples plus the beginning and end. Use technical probes for duration, dimensions, frame rate, codec, audio, and corruption.
...
4. Record observable issues with severity and evidence. Separate control-stage defects from final-refinement and post-production defects.
