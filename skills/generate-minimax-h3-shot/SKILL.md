...
8. Run local control-stage checks. Return the asset as `motion-reference` or another declared control role; do not claim it is the final delivery video.
...
- H3 control is correct but final look fails after LibTV: leave this Skill and retry final refinement.
