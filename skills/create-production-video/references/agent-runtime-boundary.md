...
Studio reads Runtime projections and sends operator commands. Show project structure, references, stages, Provider tasks, candidates, reviews, costs, and deliveries. Do not duplicate ComfyUI or LibTV node editors and do not hide state in browser-only storage.
...
- HyperFrames: deterministic post-production after final-shot acceptance.
